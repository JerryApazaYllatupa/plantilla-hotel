...
var active = Object(_library_library__WEBPACK_IMPORTED_MODULE_0__["getId"])("icon-hamburger"),
    menu = Object(_library_library__WEBPACK_IMPORTED_MODULE_0__["getId"])("menu-principal"),
    activemenu = Object(_library_library__WEBPACK_IMPORTED_MODULE_0__["getId"])("navmenu"); // Active menu

Object(_library_library__WEBPACK_IMPORTED_MODULE_0__["listener"])(active, 'click', function () {
...
if (galeriaPrincipal) {
  (function () {
    ...
    var _loop = function _loop(i) {
      Object(_library_library__WEBPACK_IMPORTED_MODULE_0__["listener"])(galeria[i], 'click', function (e) {
    ...
    var sliderPrevGallery = Object(_library_library__WEBPACK_IMPORTED_MODULE_0__["getId"])('sliderPrevGallery'),
        sliderNextGallery = Object(_library_library__WEBPACK_IMPORTED_MODULE_0__["getId"])('sliderNextGallery');
    ...
    Object(_library_library__WEBPACK_IMPORTED_MODULE_0__["listener"])(sliderPrevGallery, 'click', function () {
      if (numberImg > galeria.length - 2) {
        numberImg = 0;
      }
...
/*!***********************************!*\
  !*** ./src/js/library/library.js ***!
  \***********************************/
/*! exports provided: getId, getClass, getAll, listener, ID, getDataEditor, setDataEditor, getName, ajax, ruteImg, rutePeticion, RUTEPRINCIPAL */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getDataEditor", function() { return getDataEditor; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "setDataEditor", function() { return setDataEditor; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getName", function() { return getName; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ajax", function() { return ajax; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ruteImg", function() { return ruteImg; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "rutePeticion", function() { return rutePeticion; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RUTEPRINCIPAL", function() { return RUTEPRINCIPAL; });
...
var RUTEPRINCIPAL = location.origin;

var getId = function getId(id) {
  return document.getElementById(id);
};

var getClass = function getClass(clase) {
  return document.querySelector(".".concat(clase));
};

var getAll = function getAll(clase) {
  return document.querySelectorAll(".".concat(clase));
};

var getName = function getName(name) {
  return document.getElementsByName("".concat(name));
};
...
var getDataEditor = function getDataEditor(idsection) {
  return InlineEditor.instances[idsection].getData();
};

var setDataEditor = function setDataEditor(idsection) {
  var content = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
  return InlineEditor.instances[idsection].setData(content);
};

var ruteImg = function ruteImg(rute) {
  return RUTEPRINCIPAL + "/storage/upload/".concat(rute);
};

var rutePeticion = function rutePeticion(rute) {
  return RUTEPRINCIPAL, "".concat('/' + rute);
};

var listener = function listener(element, evet, funcion) {
  if (element) {
...
__webpack_require__(/*! /home/jerry/proyectos/ITALI/hotelrojas/src/js/app.js */"./src/js/app.js");
module.exports = __webpack_require__(/*! /home/jerry/proyectos/ITALI/hotelrojas/src/scss/app.scss */"./src/scss/app.scss");
